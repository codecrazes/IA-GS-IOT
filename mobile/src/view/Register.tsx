          ...
          <View style={styles.screen}>
            ...
            <View style={styles.card}>
              ...
              <Text style={styles.subtitle}>
                {t('register.subtitle') ||
                  'Crie sua conta para começar a aprender com IA'}
              </Text>

              <Input
                placeholder={t('register.email') || t('login.email') || 'Email'}
                autoCapitalize="none"
                autoCorrect={false}
                autoComplete="email"
              ...
              <Input
                placeholder={t('register.password') || t('login.password') || 'Senha'}
                secureTextEntry
                autoCapitalize="none"
                autoCorrect={false}
              ...
              <Button
                title={t('actions.signUp') || 'Cadastrar'}
                onPress={onRegister}
                disabled={!canSubmit}
                style={styles.button}
              />
              ...
              <Text style={styles.footerText}>
                {t('register.haveAccountPrefix') || 'Já tem conta?'}{' '}
                <Text onPress={() => nav.navigate('Login')} style={styles.footerLink}>
                  {t('register.haveAccount') || 'Faça login'}
                </Text>
              </Text>
            </View>
